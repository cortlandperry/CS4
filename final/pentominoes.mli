...
val piece_in_all_orientations : PieceSet.elt -> PieceSet.t
...
val make_piece_array : (char * string) list -> board -> PieceSet.elt array
...
val make_constraints_array : (char * string) list -> board -> pconstraint array

(** Create a map between pconstraints and array indices. *)
val make_constraints_map : (char * string) list -> board -> int PconstraintMap.t
